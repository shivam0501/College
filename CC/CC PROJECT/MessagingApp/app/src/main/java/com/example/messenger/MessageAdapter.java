...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MessageViewHolder(@NonNull View itemView) {
            ...
            receiverProfileImage=(CircleImageView) itemView.findViewById(R.id.messages_profile_image);
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder holder, final int position)
    {
        ...
        if(fromMessageType.equals("text")){
            ...
            if (fromUserId.equals(messagesenderId)){
                holder.messageSenderPicture.setVisibility(View.VISIBLE);
                Picasso.get().load("https://firebasestorage.googleapis.com/v0/b/messenger-f3b81.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=b169b8f5-2537-4746-afcf-a7ef4f26f8cf").into(holder.messageSenderPicture);
                ...
                holder.receiverProfileImage.setVisibility(View.VISIBLE);
                holder.messageReceiverPicture.setVisibility(View.VISIBLE);
                Picasso.get().load("https://firebasestorage.googleapis.com/v0/b/messenger-f3b81.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=b169b8f5-2537-4746-afcf-a7ef4f26f8cf").into(holder.messageReceiverPicture);
